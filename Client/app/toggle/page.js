...
export default function InventoryPage() {
  ...
  const loadInventoryStatus = async (token) => {
    try {
      ...
      const response = await axios.get(
        'https://datahustle.onrender.com/api/admin/inventory',
        {
          headers: {
            'x-auth-token': token
          }
  ...
  const toggleItemStatus = async (network) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://datahustle.onrender.com/api/admin/inventory/${network}/toggle`, 
        {}, // empty body
  ...
  const toggleGeonettechStatus = async (network) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://datahustle.onrender.com/api/admin/inventory/${network}/toggle-geonettech`, 
        {}, // empty body
        getAuthHeaders() // pass the auth headers
      );
